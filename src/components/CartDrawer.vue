  ...
  >
    ...
    <div class="absolute right-0 top-0 h-full w-full sm:max-w-md bg-white shadow-xl flex flex-col">
      <div class="flex items-center justify-between p-4 sm:p-6 border-b">
        <h2 class="text-xl sm:text-2xl font-bold">Shopping Cart</h2>
        <button
          @click="closeDrawer"
        ...
        <div v-else class="space-y-3 sm:space-y-4">
          ...
          >
            ...
            <div class="flex-1 min-w-0">
              <h3 class="font-semibold mb-1 text-sm sm:text-base truncate">{{ item.product.name }}</h3>
              ...
              <div class="flex items-center gap-2">
                <button
                  ...
                  class="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center border rounded hover:bg-gray-100 transition-colors"
      ...
      <div v-if="cartStore.items.length > 0" class="border-t p-4 sm:p-6 space-y-3 sm:space-y-4">
        ...
        <div class="flex justify-between text-lg sm:text-xl">
