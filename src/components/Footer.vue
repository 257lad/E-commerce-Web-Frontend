    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
        ...
        <div class="col-span-1 sm:col-span-2 lg:col-span-1">
          <h3 class="text-2xl font-bold text-white mb-4">VibeShop</h3>
        ...
        <!-- Quick Links -->
        <div>
          <h4 class="text-white font-semibold mb-4 text-base sm:text-lg">Quick Links</h4>
        ...
        <!-- Customer Service -->
        <div>
          <h4 class="text-white font-semibold mb-4 text-base sm:text-lg">Customer Service</h4>
          <ul class="space-y-2 text-sm">
            <li>
        ...
        <!-- Newsletter -->
        <div>
          <h4 class="text-white font-semibold mb-4 text-base sm:text-lg">Newsletter</h4>
          ...
          <form @submit.prevent="handleSubscribe" class="space-y-3">
            <input
              ...
              class="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-white placeholder-gray-400 text-sm"
              required
            />
            <button
              type="submit"
      ...
      <div class="mt-12 pt-8 border-t border-gray-800">
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4 text-sm">
          <p class="text-gray-400">
            &copy; {{ new Date().getFullYear() }} VibeShop. All rights reserved.
          </p>
